...
get_response(Message, Response) :-
  get_time(Time),
  random_member(RandomValue, Message), %We pick a random value from the list of values in the message
  Response = _{randomValue: RandomValue, time: Time}. %time always not necessary